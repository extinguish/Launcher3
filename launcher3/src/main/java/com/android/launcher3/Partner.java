...
/**
 * Partner是用于记录当前设备当中同我们自己的程序监听来自同一个ACTION的package.
 * 即Partner程序和我们自己的程序都监听同一个Action。
 * 寻找partner的具体实现过程是通过PackageManager当中的resolvePackageInfo来
 * 实现的
 *
 *
...
public class Partner {
    ...
    static final String TAG = "Launcher3_Partner";
