...
/**
 * LauncherViewPropertyAnimator本身的构造采用的是Builder Pattern,
 * 即我们可以将多种属性动画直接拼接到一起最终形成一种新的动画
 *
 */
public class LauncherViewPropertyAnimator extends Animator implements AnimatorListener {
    private static final String TAG = "LauncherViewPropertyAnimator";

    // all of the animation property that the LauncherViewPropertyAnimator will contains
    enum Properties {
        TRANSLATION_X,
        TRANSLATION_Y,
        SCALE_X,
