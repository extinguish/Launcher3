...
public class LauncherAppState implements DeviceProfile.DeviceProfileCallbacks {
    ...
    private LauncherAppState() {
        ...
        // 将LauncherModel注册以下事件(因为LauncherModel本身是BroadcastReceiver实例)
    ...
    // TODO: debug this app more times
    public static boolean isDisableAllApps() {
        // Returns false on non-dogfood builds.
        return true;
        // TODO: 当我们采用以下的模式时，Launcher3就会自动把所有的App加载到Workspace当中
        // TODO: 但是，这并不是Google设计的初衷
        // TODO: But根据需求，我们还是需要这样来实现
        // TODO: 当然这种实现模式还是有一定的问题的，我们需要自己重新调试和确定相关的问题
