...
/**
 * AllAppsList当中存放的List就是AppsCustomizePagedView当中用到的所有的app的数据
 *
 * Stores the list of all applications for the all apps view.
 *
 */
// TODO: 考虑在Workspace当中的item添加时，不再使用Shortcut,而是使用AppInfo
// TODO: 因为我们可以考虑到AppInfo和ShortcutInfo本身都是全部基于ItemInfo的，
// TODO: 只是AppInfo本身没有Screen的概念，
// TODO: 但是AppInfo对程序的概念本身表述的更加清楚，我们可以从AppInfo来得到ShortcutInfo,
// TODO: 但是确无法从ShortcutInfo来逆向得到AppInfo
class AllAppsList {
    public static final int DEFAULT_APPLICATIONS_NUMBER = 42;

    // data当中保存的也是系统当中目前所有已经安装的App的list
    /** The list off all apps. */
    public ArrayList<AppInfo> data =
            new ArrayList<AppInfo>(DEFAULT_APPLICATIONS_NUMBER);
    // 可以说added变量当中保存了AllAppsList当中所有添加的Apps
