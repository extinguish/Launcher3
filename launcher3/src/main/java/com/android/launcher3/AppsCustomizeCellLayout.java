...
/**
 * Workspace当中每一个Element都是一个CellLayout
 * 那么这里的AppsCustomizeCellLayout就是AppsCustomizePagedView当中每一个Element，
 * 即AppsCustomizePagedView的每一页就是一个AppsCustomizeCellLayout
 *
 */
