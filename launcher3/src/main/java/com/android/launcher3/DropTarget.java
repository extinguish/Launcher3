...
public interface DropTarget {
    ...
    class DragObject {
        ...
        // 即这个DragView是从哪里生成的，例如可以是FolderInfo, Workspace, AppsCustomizePagedView等
        // 即只要实现了DragSource接口的class都可以用在这里
        ...
        public String toString() {
            return " the current drop target are X:" + x + ", and Y:" + y;
        }
    }
    ...
    /**
     * 所有的DropTarget都需要单独实现这个方法，因为DropTarget当中需要通过实现
     * acceptDrop()来进行我们真正需要的处理过程
     *
