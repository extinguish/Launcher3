 ...
 * 统计所有的App的使用信息
 *
 * Class of which using to collect the app using statics information.
 * This class will pushing all of these statics information into the
 * format of document.(当然如果Launcher3要是投身商业化的话，那么这个使用记录
 * 最后就会被我们从本地直接push到cloud Server上面)
 *
 *
 *
 */
// TODO: 其实我们可以添加一些更复杂的统计模型，
// TODO: 现在的统计模型当中只是简单的包含了一些关于app的统计过程，但是我们还可以添加一些
// TODO: 更加复杂的信息，包括在什么时候使用的是哪些程序，但是这就需要一些复杂的算法和数据结构
// TODO: 来进行建模和分析 ---> 但是很有意义！！！
public class Stats {
