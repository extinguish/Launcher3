 ...
 */
// TODO: 现在Workspace当中切换动画很有限，我们需要添加以下自己的Page View的切换动画
public class Workspace extends SmoothPagedView
        implements DropTarget, DragSource, DragScroller, View.OnTouchListener,
        DragController.DragListener, LauncherTransitionable, ViewGroup.OnHierarchyChangeListener,
        Insettable {

    private static final String TAG = "Launcher_Workspace";
    private static final String TAG_EMPTY = "Launcher_Workspace_emptyScreen";
    private static final String TAG_APP = "Launcher_workpace_DragIcon";

    // Overscroll效果实现
    // this constants are using to create the overScroll animation effect
    ...
    // EMPTY_SCREEN也是一个特殊的screen
    // 在Launcher当中我们处理特殊screen的方式就是将这个特殊的screen的screenID值尽量设置的
    // 不符合常理，可以是一个很大的Integer，也可以直接就是一个negative integer,这样就不会同正常的screen 的ID值之间
    // 发生冲突
    // The screen id used for the empty screen always present to the right.
    final static long EXTRA_EMPTY_SCREEN_ID = -201;

    // Launcer3当中定义可一个页面，这个页面当中的内容就是Custom Content，而这个Custom Content的页面
    // 的ID是特殊的，而这个特殊的ID 就是-301,
    // 对于普通的页面screen，他们的ID值都是固定好的有序的从0开始的
    ...
    // 当我们在Workspace当中拖动图标时，会有一个outline在我们所拖动的
    // 图标的周围，形成一个outline
    ...
    // FOLDER_CREATEION_TIMEOUT这个值很有意思，这个值代表的是一个阈值，
    // 即在超过FOLDER_CREATEION_TIMEOUT这个值之后，我们就会可以将桌面上的两个
    // 图标合并，然后形成一个文件夹。
    // 注意这个值如果很大的话，那么就会出现一些很有趣的现象，例如，如果我将这个值改成1000的话，
    // 那么Workspace上的两个Shortcut就无法合并成一个Folder，而是不停的移动
    ...
    // Workspace当中的Folder是一个ring，即一个圆环
    ...
    // 实现自DragController.DragListener当中所定义的接口方法
    @Override
    public void onDragStart(final DragSource source, Object info, int dragAction) {
        Log.d(TAG_EMPTY, " ------------->inside Workspace the drag are started<------------------ ");
        ...
        // 如果我们要Drag的程序本身是系统的程序的话，那么我们是可以直接直接将这个程序卸载掉的
        // 但是如果要Drag的程序本身是系统程序的话，那么我们是不能卸载这个程序的
        // 这样的DeleteZone当中显示的图标就不是垃圾箱，而是一个Info的图标(具体的过程可以参考Huawei的具体显示过程)
        UninstallShortcutReceiver.enableUninstallQueue();
        post(new Runnable() {
            @Override
            public void run() {
                if (mIsDragOccuring) {
                    Log.d(TAG_EMPTY, " ------- and we need to add extra empty screen at here ... -------");
    ...
    public void onDragEnd() {
        Log.d(TAG_APP, " Inside Workspace --> onDrag end ... ");
        if (!mDeferRemoveExtraEmptyScreen) {
            // 因为我们每次的drag开始之后，都会默认的首先增加一个EmptyScreen,然后
            // 在最终用户停止了drag之后，再决定是否要保留这个EmptyScreen,
            // 以下就是这个判断过程
        ...
        // 下面的mLauncher.onInteractionEnd()方法内部并没有做什么实质性的工作，仅仅是调用了
        // LauncherExtension当中的onInteractionEnd()方法
    ...
    /**
     * 这里的onChildViewAdded()方法指的是向Workspace当中添加CellLayout的过程
     *
    ...
    public void onChildViewAdded(View parent, View child) {
        ...
        // 设置相关的Accessibility，关于Accessibility Event可以参考相关的IME的介绍
    ...
    /**
     * 遍历当前的dragLayer,然后得到所有的Folder对象，然后查看这个Folder对象当中的opened标记是否被标记了
     *
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////////////////////////////////////
    // 以下的方法全部是用于当我们长按屏幕时，用于添加screen的实现方法
    //////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public long insertNewWorkspaceScreen(long screenId) {
        Log.d(TAG, " --------2. start insert the screen into workSpace --------");
    ...
    public long insertNewWorkspaceScreen(long screenId, int insertIndex) {
        ...
        Log.d(TAG, "--------3. START THE REAL PROCESS OF INSERTING SCREEN INTO WORKSPACE ----------");
    ...
    public void createCustomContentContainer() {
        ...
        // TODO: add what we need to the customScreen layout
        // TODO: the customScreen are just one ViewGroup, so
        // TODO: it can add any kinds of view component into it
        // TODO: directly
    ...
    // TODO: add the custom content we need here ...
    ...
    public void addExtraEmptyScreenOnDrag() {
        ...
        // empty screen are special in workSpace, so we use one special
        // pre-defined value to tag this newly created empty screen
        if (!mWorkspaceScreens.containsKey(EXTRA_EMPTY_SCREEN_ID)) {
            Log.d(TAG_EMPTY, " ---------1. start insert new screen into workSpace screen---------- ");
    ...
    public boolean addExtraEmptyScreen() {
        ...
        Log.d(TAG, " ------- add extra empty screen ---------");
    ...
    private void convertFinalScreenToEmptyScreenIfNecessary() {
        ...
        Log.d(TAG_EMPTY, " convert final screen to empty screen if necessary ... ");
    ...
    public void removeExtraEmptyScreenDelayed(final boolean animate, final Runnable onComplete,
        ...
        Log.d(TAG_EMPTY, "------remove extra empty screen delayed ---------");
        if (mLauncher.isWorkspaceLoading()) {
    ...
    private void fadeAndRemoveEmptyScreen(int delay, int duration, final Runnable onComplete,
        ...
        Log.d(TAG_EMPTY, " ------- fade and remove empty screen ---------- ");
    ...
    public long commitExtraEmptyScreen() {
        ...
        Log.d(TAG_EMPTY, " ------- commit extra empty screen -------");
        if (mLauncher.isWorkspaceLoading()) {
            // Invalid and dangerous operation if workspace is loading
            Launcher.addDumpLog(TAG, "    - workspace loading, skip", true);
            return -1;
    ...
    public void stripEmptyScreens() {
        ...
        Log.d(TAG_EMPTY, " ----->stripe empty screen<-------- ");
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////
    // 以上 的方法全部是用于当我们长按屏幕时，用于添加screen的实现方法
    //////////////////////////////////////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////////////////////////////////////


    // See implementation for parameter definition.
    // 这个主要是针对于当用户从AppsCustomizePagedView或者Hostseat当中的App拖拽到
    // Workspace当中形成的Shortcut
    ...
    void addInScreen(View child, long container, long screenId, int x, int y, int spanX, int spanY,
        ...
        Log.d(TAG, " add child in this screen : " + screenId);
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        switch (ev.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                // 当我们获取到点击事件之后，记录下点击的位置和时间
                mXDown = ev.getX();
                mYDown = ev.getY();
                // 记录点击的时间，用于判断和处理复杂的点击事件
    ...
    // this method are here using to handle the
    // page indicator click events handler
    @Override
    ...
    protected void screenScrolled(int screenCenter) {
        ...
        if (shouldOverScroll) {
            // apply the overScroll effect here
            int index = 0;
    ...
    /**
     * 当Wallpaper被点击之后的处理过程
     * 在Workspace当中的Wallpaper被点击之后，Wallpaper本身会出现响应的Parrallex Effect(即视差效果)
     *
     * @param ev
     */
    ...
    void startDrag(CellLayout.CellInfo cellInfo) {
        Log.d(TAG_APP, " start drag for this : " + cellInfo);
    ...
    public void beginDragShared(View child, DragSource source) {
        Log.d(TAG_APP, " Inside the workSpace, and we are here begin the drag sharing ... ");
        Log.d(TAG_APP, " and the DragSource are : " + source.toString());
        ...
        // mLauncher.onDragStarted()方法的实现仅仅是完成将当前的Workspace的screen移动到指定的screen当中
        Log.d(TAG_APP, " into launcher, and inform the drag has been started ... ");
        ...
        if (child instanceof BubbleTextView) {
            Log.d(TAG_APP, " the item we are dragging are the normal AppIcon ... ");
            int iconSize = grid.iconSizePx;
            ...
            Log.d(TAG_APP, " the item we are dragging are the Folder ... ");
        ...
        if (child.getTag() == null || !(child.getTag() instanceof ItemInfo)) {
            ...
            Log.d(TAG, " exception happened, and reason are : " + msg);
        ...
        if (child.getParent() instanceof ShortcutAndWidgetContainer) {
            Log.d(TAG_APP, " the child parent are the ShortcutAndWidgetContainer ... ");
            // 初始化mDragSourceInternal变量
            mDragSourceInternal = (ShortcutAndWidgetContainer) child.getParent();
        }

        // 简单的回收一下我们为App Icon所创建的Bitmap
        b.recycle();
    }

    public void beginExternalDragShared(View child, DragSource source) {
        Log.d(TAG_APP, " begin external drag shared from here ... ");
        LauncherAppState app = LauncherAppState.getInstance();
        DeviceProfile grid = app.getDynamicGrid().getDeviceProfile();
        int iconSize = grid.iconSizePx;
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // 用于判断当前我们在CellLayout上面Drag和Drop Item时是否需要创建或者修改文件夹
    ////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                public void run() {
                    ...
                    switch (pendingInfo.itemType) {
                        case LauncherSettings.Favorites.ITEM_TYPE_APPWIDGET:
                            Log.d(TAG_APP, " we are dropping the AppWidget external from here ... ");
                            int span[] = new int[2];
                            span[0] = item.spanX;
                            span[1] = item.spanY;
                        ...
                        case LauncherSettings.Favorites.ITEM_TYPE_SHORTCUT:
                            Log.d(TAG_APP, " we are dropping the app shortcut external from here ... ");
                            mLauncher.processShortcutFromDrop(pendingInfo.componentName,
                                    container, screenId, mTargetCell, null);
                            break;
                        default:
                            Log.d(TAG_APP, " we are dropping fucking UNKNOWN type from here ... ");
     ...
     * 即如果我们是从AppsCustomizePagedView当中来进行drag一个View的话，在Drag结束之后
     * 是不会调用onDropCompleted()方法
     */
    public void onDropCompleted(final View target, final DragObject d,
                                final boolean isFlingToDelete, final boolean success) {
        Log.d(TAG_DISMISS, " 2. the drop process are complete at here ...  ");
        if (mDeferDropAfterUninstall) {
            mDeferredAction = new Runnable() {
                public void run() {
                    Log.d(TAG_DISMISS, " 3. on Drop complete execute at here ... ");
                    onDropCompleted(
                            target,
                            d,
                            isFlingToDelete,
        ...
        Log.d(TAG_DISMISS, " the parameter we received are ---> target : " + target.getTag() + " ; dragObject " + d.dragInfo
                + "; isFlingToDelete : " + isFlingToDelete + "; success : " + success);
        Log.d(TAG_DISMISS, "\n\n\n");
        boolean beingCalledAfterUninstall = mDeferredAction != null;

        Log.d(TAG_DISMISS, " the parameter we transfer are ----> success : " + success + "; beingCalledAfterUninstall : " + beingCalledAfterUninstall
                + "; uninstallSuccessful : " + mUninstallSuccessful);
        ...
        if (success && !(beingCalledAfterUninstall && !mUninstallSuccessful)) {
            ...
            if (target != this && mDragInfo != null) {
                ...
                if (parentCell != null) {
                    Log.d(TAG_DISMISS, " we are remove the cell from workspace ... ");
                    parentCell.removeView(mDragInfo.cell);
                } else if (LauncherAppState.isDogfoodBuild()) {
                    throw new NullPointerException("mDragInfo.cell has null parent");
                }
                if (mDragInfo.cell instanceof DropTarget) {
                    Log.d(TAG_DISMISS, " remove the drop target ... ");
                    mDragController.removeDropTarget((DropTarget) mDragInfo.cell);
                }
            }
        } else if (mDragInfo != null) {
            Log.d(TAG_DISMISS, " we are enter another one ... ");
            CellLayout cellLayout;
            if (mLauncher.isHotseatLayout(target)) {
                Log.d(TAG_DISMISS, " is in Hotseat ... ");
            ...
            if (cellLayout != null) {
                Log.d(TAG_DISMISS, " drop child on cell ... ");
    ...
    public void deferCompleteDropAfterUninstallActivity() {
        Log.d(TAG_DISMISS, " inside workspace, and we are defer complete drop after uninstalling activity ");
        mDeferDropAfterUninstall = true;
    }

    private static final String TAG_DISMISS = "Workspace_DismissBug";
    /// maybe move this into a smaller part
    public void onUninstallActivityReturned(boolean success) {
        Log.d(TAG_DISMISS, " 1. inside workspace, and we are here waiting for the uninstalling return ... ");
    ...
    // 将workspace的screen的准确状态保存到DB当中
    // 在这里WorkSpace的状态是以cellLayout为单位进行保存
    // 因为Workspace当中可以操作的基本单元就是CellLayout
    ...
    /**
     * 当我们设置下面的这个属性值为false时，那么当我们从Workspace当中remove一个Item
     * 会发现不成功，即每次我们将这个Item remove掉之后又会重新生成(注意我们就是remove掉
     * 普通的由第三方程序生成的Shortcut，而不是指普通的Icon)
     *
     * @return
     */
    @Override
    ...
    public boolean supportsAppInfoDropTarget() {
        // TODO: 当我们不需要InfoDropTarget时，我们直接将这里设置为false就可以了
        // TODO: 现在的Bug是，当我们将普通的快捷方式拖动到InfoDropTarget当中时，
        // TODO: 图标会自动被删除，但是当我们把这个图标放入到DeleteDropTarget当中时
        // TODO: 这个图标反而不会被删除，这就是一个很严重的问题，总是感觉逻辑倒过来了
        // TODO: 问题本身可能是处在child.reLayout()这个逻辑当中了，
        // TODO: 但是我们目前还没有发现整个过程真正的Bug的所在
        // TODO: 因为跟踪代码之后发现不到 任何同图标删除相关的操作???
        // TODO: 暂时先放弃这个功能，等到2.0版本的时候再加上
        // TODO: 时间来不及了
        return false;
    }
    ...
    void removeItemsByComponentName(final HashSet<ComponentName> componentNames,
        ...
        Log.d(TAG, " remove item by componentName --> " + componentNames);
        ArrayList<CellLayout> cellLayouts = getWorkspaceAndHotseatCellLayouts();
    ...
    void updateShortcuts(ArrayList<ShortcutInfo> shortcuts) {
        Log.d(TAG, " update shortcuts of : " + shortcuts.size());
    ...
    private void moveToScreen(int page, boolean animate) {
        Log.d(TAG_APP, " move to screen : " + page);
        if (!workspaceInModalState()) {
            if (animate) {
                snapToPage(page);
            } else {
    ...
    /**
     * 即我们添加AppWidget时，并不是立即更新这个Widget的内容，而是在完全完成添加之后在进行AppWidget内容的更新
     * <p/>
     * <p/>
        ...
        public void run() {
            ...
            for (LauncherAppWidgetInfo info : mInfos) {
                if (info.hostView instanceof PendingAppWidgetHostView) {
                    ...
                    Log.d(TAG, " remove the app widget");
