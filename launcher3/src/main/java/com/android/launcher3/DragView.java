...
/**
 * DragView就是当我们在一Workspace上或者AppsCustomizePagedView上面drag任何一个item
 * 时，这时Launcher的处理策略是重新创建了一个View，而这个View就是这里定义的DragView,
 * 这个DragView的内容就是依据于我们所Drag的Item生成的
 *
 *
 */
public class DragView extends View {

    private static final String TAG = "Launcher3_DragView";
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // 以上全部都是Setter和Getter，以及其他用于创造动画效果的属性修改方法
    // 我们需要利用这个信息来构造PropertyAnimator
    ////////////////////////////////////////////////////////////////////////////////////////////////

    @Override
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        // 对于DragView的大小，就直接设置为mBitmap的大小，
        // 而这个mBitmap就是根据我们所Drag的View或得到的Drawable，然后再由这个Drawable得到这个Bitmap
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Log.d(TAG, " Normal drawing ... ");
        mHasDrawn = true;
        Log.d(TAG, " CrossFadeProgress value > 0 ? " + (mCrossFadeProgress > 0));
        Log.d(TAG, " mCrossFadeBitmap are not null ? " + (mCrossFadeBitmap != null));
