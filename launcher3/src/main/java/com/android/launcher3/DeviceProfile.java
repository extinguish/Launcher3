...
/**
 * Class of which using to keep track all of the basic information
 * of the current device that the Launcher3 is installed on
 */
public class DeviceProfile {
    ...
    float numRows;
    float numColumns;
    // 即Launcher当中的Hotseat当中可以存放的Icon数目是根据当前的Device的Screen分辨率来决定的
    // TODO: 但是我们在以后的升级版本当中需要将这个Hotseat当中的icon数目改成可以动态进行添加
    // TODO: 和改变的
