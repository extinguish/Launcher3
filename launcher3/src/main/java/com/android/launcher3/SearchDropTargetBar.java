...
// SearchDropTargetBar本身管理的仅仅是在Delete结束之后负责控制将SearchBar的显示工作
/**
...
public class SearchDropTargetBar extends FrameLayout implements DragController.DragListener {
    ...
    public void setup(Launcher launcher, DragController dragController) {
        Log.d(TAG, " on search drop bar setup");
    ...
    public void setQsbSearchBar(View qsb) {
        Log.d(TAG, " set the Qs search Bar ... ");
        mQSBSearchBar = qsb;
    ...
    // 这个过程好像并没有做啥重要工作，仅仅就是将将要animate的View设置了一下硬件加速的过程
    private void prepareStartAnimation(View v) {
        // Enable the hw layers before the animation starts (will be disabled in the onAnimationEnd
        // callback below)
        if (v != null) {
            v.setLayerType(
                    View.LAYER_TYPE_HARDWARE, // layer type
                    null // paint object
            );
        }
    }

    // 初始化SearchBar动画需要的Interpolator以及duration初始化
    ...
    protected void onFinishInflate() {
        ...
        Log.d(TAG, " on SearchDropTargetBar finish inflate process ... ");
    ...
    //////////////////////////////////////////////////////////////////////////////////////////
    // 以上是SearchDropTargetBar的初始化过程
    //////////////////////////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////////////////////////

    public void finishAnimations() {
        Log.d(TAG, " finish animations ... ");
    ...
    public void showSearchBar(boolean animated) {
        Log.d(TAG, " begin showing the searchBar from here ... ");
    ...
    public void onDragStart(DragSource source, Object info, int dragAction) {
        // 这个方法当中没有对DragTarget进行任何操作，即没有对Info进行任何相关的操作
        Log.d(TAG, " onDrag start ... ");
        // Animate out the QSB search bar, and animate in the drop target bar
        prepareStartAnimation(mDropTargetBar);
        mDropTargetBarAnim.start();
        if (!mIsSearchBarHidden) {
            // 每当我们的Drag开始时，我们需要将我们的SearchBar hide掉
            // 如果我们的SeachBar正在显示，那么就hide
            prepareStartAnimation(mQSBSearchBar);
            mQSBSearchBarAnim.start();
        }
    }
